...
import { EditIcon, ClientsIcon, InventoryIcon, SalesIcon, RequestsIcon, CalendarPlusIcon, PurchaseOrderIcon, ClipboardCheckIcon, ClaimsIcon } from '../components/icons/Icons';
